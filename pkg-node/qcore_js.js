 ...
 * @returns {string}
 */
function buildSignedOrderCall(contract, selector_hex, scheme_off, ptr_off, field_offs_csv, fields_csv, region_off, owner_seed_hex, owner_index, nonce) {
    let deferred7_0;
    let deferred7_1;
    try {
 ...
 * @returns {string}
 */
function signRegister(seed_hex, index, nonce, fee) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(seed_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
function sign_call(seed_hex, index, target, args_hex, nonce, meter_limit, fee) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(seed_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
function sign_transfer(seed_hex, index, to, amount, nonce, fee) {
    let deferred6_0;
    let deferred6_1;
    try {
        const ptr0 = passStringToWasm0(seed_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
