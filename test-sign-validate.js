...
for (const b of bad) {
  let threw = false;
  try { core.sign_transfer(seed, 0n, b, '5', 0n, '1'); } catch { threw = true; }
...
const a = JSON.parse(core.sign_transfer(seed, 0n, good, '9007199254740992', 0n, '1')).tx_hex;
const b = JSON.parse(core.sign_transfer(seed, 0n, good, '9007199254740993', 0n, '1')).tx_hex;
